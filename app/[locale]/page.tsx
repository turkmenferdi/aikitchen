        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-4 pb-20 pt-14 sm:px-6 md:pt-20 lg:grid-cols-[1.08fr_1fr] lg:gap-16 lg:px-8 lg:pb-28">
          <div>
            ...
            <h1 className="mb-6 text-[2.5rem] font-extrabold leading-[1.08] tracking-tight text-on-surface sm:text-5xl lg:text-[3.4rem]">
              {home.hero.title}{' '}
              <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">{home.hero.titleHighlight}</span>
            </h1>
            ...
            <div className="mt-10">
              ...
              <ul className="flex flex-wrap gap-2">
                {home.hero.systems.map((system) => (
                  <li key={system} className="rounded-lg border border-outline-variant bg-white px-3 py-1.5 text-sm font-medium text-on-surface">
                    {system}
                  </li>
                ))}
              </ul>
      ...
      <section className="bg-surface py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <article className="flex flex-col rounded-3xl border border-outline-variant bg-white p-8 shadow-sm md:p-10">
              ...
              <Link href={`/${validLocale}/platform`} className="mt-auto inline-flex items-center gap-2 font-semibold text-primary hover:gap-3">
                {automation.cta}
      ...
      <section id="how-it-works" className="scroll-mt-24 bg-surface py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <ol className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {home.howItWorks.steps.map((step, idx) => {
              ...
              return (
                <li
                  key={step.title}
                  className={`relative rounded-2xl border p-6 ${isHuman ? 'border-primary/30 bg-primary/5' : 'border-outline-variant bg-white'}`}
                >
          ...
          <p className="mt-8 flex items-center justify-center gap-2 text-center text-on-surface-variant">
            <ShieldCheck size={18} className="flex-shrink-0 text-primary" />
