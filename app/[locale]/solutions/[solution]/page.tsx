    ...
    <>
      ...
      <section className="py-6 bg-surface-container-low border-b border-outline/20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <ArrowLeft size={18} />
            {isEnglish ? 'Back to Solutions' : 'Çözümlere Dön'}
          </Link>
        </div>
      </section>
      ...
      <section className="py-20 md:py-32 bg-surface-container-low">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-on-surface mb-6">
            {isEnglish ? 'Challenge' : 'Mevcut Zorluk'}
          </h2>
      ...
      <section className="py-20 md:py-32 bg-surface">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-on-surface mb-6">
            {isEnglish ? 'Our Solution' : 'Önerdiğimiz Yapı'}
          </h2>
          ...
          <div className="bg-surface-container-high rounded-lg border border-outline/20 p-8">
            <h3 className="text-xl font-semibold text-on-surface mb-6">
              {isEnglish ? 'Key Capabilities' : 'Öne Çıkan Yetkinlikler'}
            </h3>
      ...
      <section className="py-20 md:py-32 bg-surface-container-low">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-on-surface mb-12 text-center">
            {isEnglish ? 'Expected Outcomes' : 'Beklenen Kazanımlar'}
          </h2>
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <CTABanner
            heading={
              isEnglish ? `${data.name} - Ready to Start?` : `${data.name} için ilk adımı atalım`
            }
            description={
              isEnglish
