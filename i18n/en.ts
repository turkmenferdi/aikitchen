export const en = {
  ...
  contact: {
    meta: {
      title: 'Contact and Demo Request | AI Kitchen',
      description: 'Get in touch with AI Kitchen about process automation or TurboHUB, and let’s review your process together.',
    },
    hero: {
      eyebrow: 'Contact',
      title: 'Let’s take the first step toward automation together',
      description:
        'Let’s review your workflows together and decide whether a reusable scenario or a custom deployment is the better fit.',
    },
    steps: {
      heading: 'What happens in the call?',
      items: [
        { title: 'We listen to your process', description: 'We talk through the repetitive work, the systems involved and the control steps.' },
        { title: 'We assess the fit', description: 'We identify the steps suited to automation and the likely scope together.' },
        { title: 'We propose the next step', description: 'We share a clear recommendation for a demo, process discovery or pilot.' },
      ],
    },
    ...
    form: {
      ...
      error: 'There was an error sending your message. Please try again or reach us by email.',
      ...
      placeholderMessage: 'Briefly describe the process you want to automate or the management questions you want TurboHUB to answer',
      optionAutomation: 'Process automation (general)',
      ...
      optionOther: 'Other',
      consent: 'By submitting this form, you agree that the information you share will be used only to respond to your request.',
    },
    channels: {
