export const tr = {
  ...
  contact: {
    meta: {
      title: 'İletişim ve Demo Talebi | AI Kitchen',
      description: 'Süreç otomasyonu veya TurboHUB için AI Kitchen ile iletişime geçin; sürecinizi birlikte değerlendirelim.',
    },
    hero: {
      eyebrow: 'İletişim',
      title: 'Otomasyon için ilk adımı birlikte atalım',
      description:
        'Süreçlerinizi birlikte inceleyelim; hazır senaryo mu, özel kurulum mu daha doğru birlikte belirleyelim.',
    },
    steps: {
      heading: 'Görüşmede neler olur?',
      items: [
        { title: 'Sürecinizi dinleriz', description: 'Tekrarlanan işi, kullanılan sistemleri ve kontrol adımlarını konuşuruz.' },
        { title: 'Uygunluğu değerlendiririz', description: 'Otomasyona uygun adımları ve olası kapsamı birlikte belirleriz.' },
        { title: 'Sonraki adımı öneririz', description: 'Demo, süreç keşfi veya pilot için net bir öneri paylaşırız.' },
      ],
    },
    ...
    form: {
      ...
      error: 'Mesaj gönderilirken bir hata oluştu. Lütfen tekrar deneyin veya e-posta ile ulaşın.',
      ...
      placeholderMessage: 'Otomatikleştirmek istediğiniz süreci veya TurboHUB ile yanıtlamak istediğiniz yönetim sorularını kısaca anlatın',
      optionAutomation: 'Süreç otomasyonu (genel)',
      ...
      optionOther: 'Diğer',
      consent: 'Formu göndererek, paylaştığınız bilgilerin yalnızca talebinize dönüş yapmak amacıyla kullanılmasını kabul etmiş olursunuz.',
    },
    channels: {
