...
const statusStyles: Record<StepStatus, { icon: typeof Check; ring: string; text: string }> = {
  ...
  warning: { icon: TriangleAlert, ring: 'bg-amber-50 text-amber-600 ring-amber-500/30', text: 'text-on-surface' },
  human: { icon: UserRound, ring: 'bg-primary/10 text-primary ring-primary/30', text: 'text-on-surface' },
